...
### 2.2 V1 明确排除（不做、不测试）
- ❌ 键盘指法提示（用户明确未选择）。
- ~~❌ 历史记录与统计。~~ → **V2+ 已落地**（见 architecture.md §1.2）。
- ~~❌ 文章分类 / 难度分级。~~ → **V2+ 已落地**（书库五分类 #33，见 architecture.md §1.2）。
- ~~❌ 侧边栏目录。~~ → **V2+ 已落地**（以 HomeView 书库首页承接，见 architecture.md §1.2）。
...
| ~~Won't（V1）~~ | 历史记录与统计 | ~~❌~~ ✅ | **V2+ 已落地**（见 architecture.md §1.2） |
| ~~Won't（V1）~~ | 文章分类 / 难度分级 | ~~❌~~ ✅ | **V2+ 已落地**（#33 书库五分类，见 architecture.md §1.2） |
| ~~Won't（V1）~~ | 侧边栏目录 | ~~❌~~ ✅ | **V2+ 已落地**（HomeView 承接，见 architecture.md §1.2） |
